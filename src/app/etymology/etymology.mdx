...
_**sidenote**: many of these little trivia were posted as tweets on my old deleted account several moons ago. thanks to gpt and claude, i was able to retrieve them from that massive tweet archive (over 270k tokens even after cleaning up). i also used these ai tools for some initial formatting and cleaning up, hence the language might sound a little ai-esque right now. i'll manually reword them all later._
...
"Badam" is the Hindi word for "almond," but in some Indian regions, particularly in Bihar, Jharkhand, Uttar Pradesh, West Bengal and surrounding states, "chiniya badam" is used to refer to peanuts. This usage highlights regional linguistic variations and how words evolve based on local customs and agricultural practices.

Fun fact: In the viral "kacha badam" meme, the man was actually selling raw peanuts, the 'kaccha chiniya badam' and not almonds.
...
- 'Erogenous': relating to areas of the body that are sensitive to sexual stimulation
...
The term 'platonic' came to be associated with the second type of love, referring to a non-erotic, spiritual love.

Interestingly, the ancient Greek word ἔραμαι (éramai) meaning "to love", which is related to ἔρως, comes from a reconstructed PIE root *h₁rem-, meaning "to rest". This root is cognate with the Sanskrit word रमते (ramate), which can mean "to delight/to enjoy/to rest/to play". This word appears in the Bhagavad Gita, Chapter 5, Verse 22.

In Gujarati, the word રમવું (ramvu) means "to play", which is derived from the same root.
...
The suffix '-lagnia' is similar to '-philia' (meaning "to love"), but implies a more intense or lustful desire. It's often contrasted with '-phobia' (meaning "an irrational fear").

'Vernalagnia' is sometimes referred to as "spring fever" in more family-friendly contexts. It describes the increase in romantic and sexual desires that often accompanies the arrival of spring.
