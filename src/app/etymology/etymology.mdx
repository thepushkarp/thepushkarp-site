...
The Urdu word "falsafa" which means philosophy is actually borrowed from the Greek word "philosophia" meaning the same thing. Infact, the word was borrowed as is with some minor modifications to fit the phonetic and grammatical context of the Urdu language and words borrowed directly in such a way are called "loanwords".
...
Repertoire (रेपटवा), boudoir (बूद्ध्वा), memoire (मेमवा), abattoir (अबत्ट्वा) and reservoire (रेसर्वा) are French words borrowed into English that end with -oire or -oir. These words are very easy to pronounce like a true Frenchperson if you start to think of them like Bhojpuri words such as बबुआ, रमुा, बलमवा.
